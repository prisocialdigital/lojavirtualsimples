                    ...
                    <div class="card-text"> <br>
                        <div class="row no-gutters">
                            <div class="col-md-6 "> <br>
                                <!--imagem do perfume-->
                                <img src="../loja/perfume miss dior.png"
                                    class="img-fluid rounded-start text-align-center" alt="..."><br>
                            </div>
                            ...
                            <div class="col-md-6"><br>
                                <div class="col-md-12 offset-md-3 text-left h-center">
                                    ...
                                    <h3 class="card-title"><br>
                                        Perfume Miss Dior</h3>
                                    <p class="card-text"><br>
                                        Perfume com notas de frutas<br>
                                        Aroma suave e adocicado <br>
